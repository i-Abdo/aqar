...
export default function PropertyDetailClient({ initialProperty, propertyId }: PropertyDetailClientProps) {
  ...
  const { title, description, price, wilaya, city, neighborhood, address, rooms, bathrooms, area, filters, imageUrls, createdAt, userId: propertyOwnerId, transactionType, propertyType, otherPropertyType, status, phoneNumber, whatsappNumber, facebookUrl, instagramUrl, googleMapsLink, videoUrl } = property;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6">
                ...
                {videoUrl && (
                  <Card className="shadow-lg">
                      <CardHeader>
                          <CardTitle className="font-headline text-xl flex items-center gap-2"><Video size={18}/>فيديو العقار</CardTitle>
                      </CardHeader>
                      <CardContent>
